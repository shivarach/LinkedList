...
public class QuickSortOnSLL<Item extends Comparable<Item>> implements
	...
	/**
	 * quick sort on linked list. It assumes tail node as pivot and pivot is segregated from list resulting in left and right halves which are solved recursively
	 * @param head
	 * @return
	 */
