...
/**
 * Delete alternate nodes of a Linked List in recursive way
 ...
 * @param <Item>
 */
public class DeleteAlternateNodes_Recursive_31<Item extends Comparable<Item>>
	...
	public Node deleteAlternateNodes(Node temp) {
		if (temp == null || temp.next == null)
			return temp;
		temp.next = deleteAlternateNodes(temp.next.next);
		return temp;
	}
	...
	public static void main(String[] args) {
		...
		DeleteAlternateNodes_Recursive_31<Integer> llist = new DeleteAlternateNodes_Recursive_31<Integer>();
		llist.addItem(7);
		llist.addItem(6);
		llist.addItem(5);
		llist.addItem(4);
